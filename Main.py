...
def game_logic(conFound, _imgContours, jump_distance=20):
    if conFound:
        # left most contour
        ...
        cv2.line(_imgContours, (0, left_most_contour[0]["bbox"][1] + 10),
                 (left_most_contour[0]["bbox"][0], left_most_contour[0]["bbox"][1] + 10), (00, 51, 204), 10)
...
while True:
    ...
    imgGame = capture_screen_region_opencv_mss(250, 270, 645, 200)
